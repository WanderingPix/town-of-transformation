...
public sealed class RichGuyOptions : AbstractOptionGroup<RichGuyRole>
{
    ...
    [ModdedNumberOption("Maximum Extra Lives", 0f, 5f, 0.5f, MiraNumberSuffixes.None, zeroInfinity:true)]
    public float MaxExtraLives { get; set; } = 3f;
    [ModdedNumberOption("Initial Goldify Price", 1f, 10f, 1f, MiraNumberSuffixes.None)]
    ...
    [ModdedNumberOption("Maximum Goldify Uses", 0f, 10f, 0.5f, MiraNumberSuffixes.None, zeroInfinity:true)]
    public float MaxGoldifyUses { get; set; } = 0f;
    [ModdedNumberOption("Initial Reveal Price", 1f, 10f, 1f, MiraNumberSuffixes.None)]
    ...
    [ModdedNumberOption("Maximum Reveal Uses", 0f, 10f, 0.5f, MiraNumberSuffixes.None, zeroInfinity:true)]
    public float MaxRevealUses { get; set; } = 3f;
    [ModdedNumberOption("Initial Zoomout Price", 1f, 10f, 1f, MiraNumberSuffixes.None)]
    ...
    [ModdedNumberOption("Maximum Zoomout Uses", 1f, 10f, 0.5f, MiraNumberSuffixes.None)]
    public float MaxZoomoutUses { get; set; } = 3f;
    [ModdedNumberOption("Initial Extra Vote Price", 1f, 10f, 1f, MiraNumberSuffixes.None)]
