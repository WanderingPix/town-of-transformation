...
namespace TownOfTransformation.Options.Modifiers.NeutImp;
...
public sealed class BowTieErOptions : AbstractOptionGroup<BowTieErModifier>
{
    ...
    public ModdedEnumOption BowType { get; set; } = new("TownOfTransformationOptionBowType",
        (int)BType.PinkTie, typeof(BType),
        [
            "TownOfTransformationOptionBowTypePinkTie", "TownOfTransformationOptionBowTypeAstronaut",
            "TownOfTransformationOptionBowTypePirate", "TownOfTransformationOptionBowTypeParty"
        ]);
