...
public sealed class LilGuyModifier() : BaseModifier
{
    ...
    public override void OnActivate()
    {
        ...
        Player.MyPhysics.Animations.group.RunAnim = ExampleAssets.LilGuyAnimation.LoadAsset();
        Player.MyPhysics.Animations.group.IdleAnim = ExampleAssets.LilGuyAnimation.LoadAsset();
